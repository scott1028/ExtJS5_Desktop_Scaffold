    ...
    items: [
        {
            ...
            columns: [
                ...
                { width: 'auto', flex: 1, header: 'Email', dataIndex: 'email'},
                { width: 'auto', flex: 1, header: 'Type', dataIndex: 'type'},
                { width: 'auto', flex: 1, header: 'Status', dataIndex: 'status'},
                { width: 'auto', flex: 1, header: 'SubscriberID', dataIndex: 'subscriber_id'},
                { width: 'auto', flex: 1, header: 'CardIssuer', dataIndex: 'card_issuer'},
                { width: 'auto', flex: 1, header: 'SuspendReason', dataIndex: 'suspend_reason'},
                { width: 'auto', flex: 1, header: 'LastLogin', dataIndex: 'last_login',
                  editor: {
                    xtype: 'datetimefield',
                    allowBlank: false,
                    format: 'Y-m-d H:i:s',
